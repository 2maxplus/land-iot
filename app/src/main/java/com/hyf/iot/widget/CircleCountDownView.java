...
import com.hyf.iot.utils.ImageUtil;
...
public class CircleCountDownView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        // 控制外层进度条的边距
        padding = typedArray.getDimensionPixelSize(R.styleable.CircleCountDownView_padding, DisplayUtil.dp2px(getContext(),5));
        // 进度条边线宽度
        ...
        if (borderWidth > 0) {
            ...
            if (showProgress) {
                ...
                // 进度条高斯模糊半径
                processBlurMaskRadius = typedArray.getDimensionPixelSize(R.styleable.CircleCountDownView_processBlurMaskRadius, DisplayUtil.dp2px(getContext(),5));
            }
        }
        ...
        valueTextPaint.setTextSize(typedArray.getDimensionPixelSize(R.styleable.CircleCountDownView_valueTextSize, DisplayUtil.dp2px(getContext(),13)));
