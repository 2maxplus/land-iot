...
class SignalView @JvmOverloads constructor(
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.SignalView).apply {
            ...
            signalColor = getColor(R.styleable.SignalView_signalColor, resources.getColor(R.color.colorGreen))
            defaultSignalColor = resources.getColor(R.color.color999)
            recycle()
        }
        paint = Paint()
        paint.apply {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (i in 0 until signalCount) {
            ...
            canvas.drawRect(
                    ...
                    (signalHeight * (signalCount - i) * 0.15).toFloat(),
